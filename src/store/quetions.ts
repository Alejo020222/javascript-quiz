        ...
        return {
          ...
          fetchQuestion: async (limit: number) => {
            ...
            const question = json
              ...
              .slice(0, limit);
            set({ question }, false, "FETCH_QUESTION");
          },
          selectAnswer: (questionId: number, answerIndex: number) => {
            ...
            set({ question: newQuestions }, false, "SELECT_ANSWER");
          },
          goPreviusQuestion: () => {
          ...
          goNexCuestio: () => {
            ...
            if (nexCuestion < question.length) {
              set({ currentQuestion: nexCuestion }, false, "GO_NEXT_QUESTION");
            }
          },
          reset: () => {
            set({ currentQuestion: 0, question: [] }, false, "RESET");
          },
        };
      },
      {
